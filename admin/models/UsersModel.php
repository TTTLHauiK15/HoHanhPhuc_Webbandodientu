<?php 
	trait UsersModel{
		...
		public function modelCreate(){
			...
			//lay bien ket noi
			$conn = Connection::getInstance();
			$query = $conn->prepare("insert into customers set name=:_name, email=:_email, password=:_password, address=:_address, phone=:_phone");
			$query->execute([":_name"=>$name, ":_email"=>$email, ":_password"=>$password, ":_address"=>$address, ":_phone"=>$phone]);
		}
		//xoa ban ghi
